...
class tieredImageNet(Dataset):
    ...
    def __init__(self, setname, args=None, return_path=False):
        TRAIN_PATH = osp.join(args.data_dir, '../tiered-ImageNet/train')
        VAL_PATH = osp.join(args.data_dir, '../tiered-ImageNet/val')
        TEST_PATH = osp.join(args.data_dir, '../tiered-ImageNet/test')
        if setname == 'train':
            THE_PATH = TRAIN_PATH
        elif setname == 'test':
            THE_PATH = TEST_PATH
